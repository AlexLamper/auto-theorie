    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="flex-1">
        <section>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mt-3">Wij maken theorie leren helder en overzichtelijk</h1>
        ...
        <div className="rounded-3xl border border-border bg-card p-8 shadow-sm">
          <h2 className="text-2xl font-bold text-foreground">Onze aanpak</h2>
